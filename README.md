...
**More information can be found in the BST Plus Docs here: [https://github.com/frengers/frengers/wiki](https://github.com/frengers/frengers/wiki).**

###BST Plus Child Theme

There's a BST Plus starter child theme if you are interested, called [frengers-child](https://github.com/SimonPadbury/frengers-child)
...
* A starter CSS theme - `css/frengers.css`, enqueued. (**Don't** put your own styles in `style.css`.)
...
* A few simple jQuery scripts - in `js/frengers.js`, enqueued.
...
**More information can be found in the [BST Plus Docs here](https://github.com/frengers/frengers/wiki).**

**Changelog can be [found here](https://github.com/frengers/frengers/wiki/02-Changelog).**

-----

BST Plus is the "big brother" of **BST**, Bootstrap Starter Theme [https://github.com/SimonPadbury/bst](https://github.com/SimonPadbury/bst). (BST and frengers share the same basic features; see above.)

Is frengers is too much for you? If you only need "BST with WooCommerce support, Hovernav and Meganav" then check out **WBST** – [https://github.com/SimonPadbury/WBST](https://github.com/SimonPadbury/WBST).
